...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"keycloak_realm_keystore_rsa_generated":             config.IdentifierFromProvider,
	"keycloak_realm_keystore_ecdsa_generated":           config.IdentifierFromProvider,
	"keycloak_realm_keystore_aes_generated":             config.IdentifierFromProvider,
	"keycloak_realm_keystore_hmac_generated":            config.IdentifierFromProvider,
